...
{
    class CS77_SignificanceofThreadJoinandThreadIsAlive
    {
        void Main()
        {
            Console.WriteLine("Main Started");
            Thread T1 = new Thread(CS77_SignificanceofThreadJoinandThreadIsAlive.Thread1Function);
            T1.Start();

            Thread T2 = new Thread(CS77_SignificanceofThreadJoinandThreadIsAlive.Thread2Function);
            T2.Start();
